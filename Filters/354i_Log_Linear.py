...
class User_Filter(AnalogFilter):
    filterType = '354i Log-Linear Output'
    filterIdentifier = '354iLL_MRB'
    filterVersion = '1.0'
    ...
    def procReverse(self, measurementPacket):
        ...
        measurementPacket.getMeasurements()[0].wave = np.power(10, measurementPacket.getMeasurements()[0].wave - 10)
