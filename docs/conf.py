...
htmlhelp_basename = 'DataStationdoc'
...
latex_documents = [
    (master_doc, 'DataStation.tex', 'DataStation Documentation',
     'Matthew R. Brantley', 'manual'),
]
...
man_pages = [
    (master_doc, 'datastation', 'DataStation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DataStation', 'DataStation Documentation',
     author, 'DataStation', 'One line description of project.',
     'Miscellaneous'),
]
